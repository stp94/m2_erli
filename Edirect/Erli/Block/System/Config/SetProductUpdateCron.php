 ...
 */
class SetProductUpdateCron extends Field
{

    /**
     * @var string
     */
    protected $_template = 'Edirect_Erli::system/config/set_product_update_cron.phtml';
    ...
    {
        return $this->getUrl('erli/system_config/setProductUpdateCron');
    }
        ...
        $button = $this->getLayout()->createBlock(Button::class)
            ->setData(
                [
                    ...
                    'label' => __('Set Product Full Synchronization Cron Job'),
